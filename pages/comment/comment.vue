				...
				<view class="commentList uni-flex uni-column" v-for="(item,index) in commentList.list" :key="index" @click="commDetail">
					<view class="user-comment uni-flex">
						...
						<view class="user-info uni-flex uni-column">
							...
							<text class="time text-overflow_1-xzh">{{item.time}}</text>
						</view>
					</view>
		...
		data() {
			return {
				...
				commentList:{
					...
					category:[{"title":"全部","number":''},{"title":"设计好","number":52},{"title":"质量很好","number":132},{"title":"服务不错","number":232},{"title":"一般","number":12},{"title":"差评","number":12},{"title":"好评","number":22},{"title":"实惠","number":15}]
				},				
				loadingText: '加载中...',
