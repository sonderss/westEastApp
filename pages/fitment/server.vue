<template>
	<view>
		<view class="shopInfo ed-mpi">
			...
			<view class="uni-flex">
				<image v-for="(key, index) in commentList.server" @tap="toPop(index)" :key="'key' + index" class="is-response" mode="widthFix"
...
<script>
	...
	export default {
		components: {},
		props: ['commentList', 'stars', 'sendDate'],
		data() {
			return {
				showPop: '',
			}
