<template>
	<view>
		<view style="text-align: center;line-height: 80upx; font-size: 35upx; font-weight: bold; position: fixed; z-index: 9999;height: 80upx;top: 0; right: 0;width: 100%;background: #fff;">
			装修公司
		</view>
		<view style="margin-top: 80upx;" class="ed-box" id="ed-box">
			...
			<view style="height: 100%;" duration="300" @change="swiperChange">
				<view>
					<view class="swiper-one-list" scroll-y="true">
						...
						<view class="shopInfo ed-uiTeam" id="three">
							<view class="uni-panel-h" style="padding: 0;">
...
<script>
	export default {
		props: ['stars', 'commentList', 'menuTabs', 'isFix', 'currentTab', 'sendDate'],
		data() {
			return {}
		},
		methods: {
			swichMenu:function(current){
				this.$emit('edSwichMenu',current);				
			},
