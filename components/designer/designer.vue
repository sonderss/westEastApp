...
<view style="overflow: auto;" class="app">
     ...
     <view class="main" v-if="isShow === 1 ? true :false">
         <view class="works">
             <image style="width:702upx;height:334upx" src='../../static/img/designTeam/anli/02.png' />
             <text class="title1">130㎡轻奢美式，邂逅美好的浪漫生活</text>
             <text class="title2">130㎡  |  二居  |  现代简约</text>
         </view>
         <view class="works">
             <image style="width:702upx;height:334upx" src='../../static/img/designTeam/anli/03.png' />
             <text class="title1">130㎡轻奢美式，邂逅美好的浪漫生活</text>
             <text class="title2">130㎡  |  二居  |  现代简约</text>
         </view>
         <view class="works teshu">
             <image style="width:702upx;height:334upx" src='../../static/img/designTeam/anli/01.png' />
             <text class="title1">130㎡轻奢美式，邂逅美好的浪漫生活</text>
             <text class="title2">130㎡  |  二居  |  现代简约</text>
         </view>
