        ...
        <view class="person_view" v-for="(item,index) in list" :key='index'>
            ...
            <view class="top-person" >
                <view style="   display: flex;  justify-content: space-between;align-items: center;" @tap='goMine'>
                    <view style="width:88upx;height:88upx;" > 
                         <image src='../../static/img/fitment/7@2x.png' style="width:100%;height:100%;margin-left:25upx"/>
                    </view>
                    <view class="mine_" >
                            <text class="nickname" >{{name}}</text>
                             <text v-if="isMy" class="mine_time">{{item.time}}</text>
                    </view>
            ...
            <view >
                <view class="mid_photo">
                    <view class="photo"  v-for="i in item.photo" :key='i'>
                        <image style="width:220upx;height:220upx" :src='i'/>
            ...
            <!-- 底部 -->
             <view class="btm">
                 <view>
                      <view class="btn"><text style="margin-right:15upx">装修日记</text><text class="iconfont ico">&#xe60f;</text></view>
                 ...
                 <view class="btm_right" >
                          ...
                          <text >({{item.num1}})</text>
                        <image style="width:35upx;height:33upx" @tap.stop="dianzan(index,$event)" ref='isZan1' :src="item.dianzan ? '../../static/img/cjq-about/icons/kongxin_zan.png': '../../static/img/cjq-about/icons/shixin_zan.png' "/>
                          <text>({{item.num2}})</text>
...
export default {
    ...
    methods: {
        ...
        //         if( this.isZan){
        //             this.$set(item,'src',this.dianzanIcon)
        //         }else{
        //             this.$set(item,'src',this.dianzanIcon1)
        //         }
